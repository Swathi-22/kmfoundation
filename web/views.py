...
from web.models import ServiceCatagory
...
def service(request,id):
    service = Service.objects.filter(service_catagory = id)
    print(service,'########################')
    context = {
        "is_service":True,
        "service":service
...
def university_detail(request,id):
    ...
    # course = Course.objects.filter(course_type=course_type.course_name,course_type=course.course_type)
